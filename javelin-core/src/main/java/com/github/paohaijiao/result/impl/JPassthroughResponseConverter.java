 ...
 * @author Martin
 * @version 1.0.0
 * @className JPassthroughResponseConverter
 * @date 2025/6/28
 * @description
 */
public class JPassthroughResponseConverter implements JResultConverter<JResult> {
    @Override
    public JResult convert(JResult response) {
        return response;
    }
}
